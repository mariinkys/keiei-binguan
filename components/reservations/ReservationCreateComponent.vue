   ...
   <div class="max-w-5xl m-auto">
      <form @submit.prevent="onSubmit" class="flex flex-col gap-8">
         ...
         <span class="p-float-label">
            <Calendar v-model="reservation.checkInDate" dateFormat="dd/mm/yyyy" showIcon class="w-full" />
            <label for="checkInDate">Check In</label>
         </span>

         <span class="p-float-label">
            <Calendar v-model="reservation.checkOutDate" dateFormat="dd/mm/yyyy" showIcon class="w-full" />
